...
import 'package:digital_dairy/features/cattle/presentation/widget/cattle_milk_log_card.dart';
...
class _CattleMilkDetailScreenState extends State<CattleMilkDetailScreen> {
  ...
  SliverList _buildMilkList(List<MilkModel> logs) => SliverList(
    delegate: SliverChildBuilderDelegate(
      (BuildContext context, int index) => CattleMilkLogCard(milk: logs[index]),
